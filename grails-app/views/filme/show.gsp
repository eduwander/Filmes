	...
	<body>
		...
		<div id="show-filme" class="content scaffold-show" role="main">
			...
			<ol class="property-list filme">
				...
				<g:if test="${filmeInstance?.anoLancamento}">
				<li class="fieldcontain">
					<span id="anoLancamento-label" class="property-label"><g:message code="filme.anoLancamento.label" default="Ano Lancamento" /></span>
					
						<span class="property-value" aria-labelledby="anoLancamento-label"><g:fieldValue bean="${filmeInstance}" field="anoLancamento"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${filmeInstance?.categoria}">
				<li class="fieldcontain">
					<span id="categoria-label" class="property-label"><g:message code="filme.categoria.label" default="Categoria" /></span>
					
						<span class="property-value" aria-labelledby="categoria-label"><g:link controller="categoria" action="show" id="${filmeInstance?.categoria?.id}">${filmeInstance?.categoria?.encodeAsHTML()}</g:link></span>
